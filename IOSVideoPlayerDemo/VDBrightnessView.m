...
@end
@implementation VDBrightnessView
+ (instancetype)sharedBrightnessView {
    static VDBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[VDBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage.image        = VDPlayerImage(@"ZFPlayer_brightness");
